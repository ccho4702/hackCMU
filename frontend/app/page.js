    ...
    <div className="app-shell">
      ...
      <main className="workspace">
        ...
        {hasResults && <section className="results-section" aria-labelledby="results-title">
          ...
          {audioUrl && <div className="practice-cta"><div><h3>Ready to make it your own?</h3><p>Read this script, record your voice, and compare each new trial with your TTS reference.</p></div><Link className="button primary-button" href={`/practice?run=${job.run_id}`}>Practice this script <span>↗</span></Link></div>}
