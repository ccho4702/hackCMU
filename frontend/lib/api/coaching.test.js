...
test("retry preserves the originally selected language and accent and sends multipart data", async () => {
  ...
  expect(await beginCoaching(file,"analysis-1","en","british")).toBeUndefined();
